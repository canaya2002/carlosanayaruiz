...
export const MEDIA_SLOTS: readonly MediaSlot[] = [
  ...
  /* ── LA PORTADA · UNA SEGUNDA PRUEBA ──────────────────────────── */
  {
    id: 'home-evidencia',
    kind: 'image',
    path: '/media/home/antes-despues.png',
    width: 1600,
    height: 900,
    page: '/es',
    where: 'RETIRADO — ese sitio lo ocupa ahora la cinta de documentos',
    what: 'RETIRADO POR DECISIÓN DEL DUEÑO, por la misma razón que el de /seo-tecnico: eran datos de Search Console de su empleador, con el dominio a la vista. Ese sitio de la portada lo ocupa ahora `<DocStrip>`, la cinta con los ocho certificados que SÍ son suyos y llevan su nombre impreso.',
    alt: 'Antes y después de una intervención técnica, con el eje de tiempo visible',
    priority: 'baja',
    filled: false,
    notes:
