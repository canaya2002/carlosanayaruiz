...
export const MEDIA_SLOTS: readonly MediaSlot[] = [
  ...
  /* ── LA PORTADA · UNA SEGUNDA PRUEBA ──────────────────────────── */
  {
    ...
    height: 900,
    page: '/es',
    where: 'Sección «El registro», debajo de la gráfica de trayectoria',
    what: 'UNA sola imagen que sea la prueba de todo el sitio: Search Console o CrUX con un antes y un después, el eje de tiempo visible y la curva moviéndose en la dirección correcta. Si solo consigues un archivo de toda esta lista, que sea este.',
