...
Mi enfoque combina ingeniería de alto rendimiento con estrategia SEO técnica: arquitectura de información, datos estructurados (Schema.org/JSON-LD), Core Web Vitals, internacionalización (i18n/hreflang) y rendimiento web. He liderado equipos multidisciplinarios en Amazon, Master Loyalty Group y Wan Hai Lines, optimizando procesos y alineando tecnología con objetivos de negocio y crecimiento orgánico.`,
    shortBio:
      'Ingeniero de software y consultor SEO técnico en México. Construyo sitios web rápidos, indexables y que convierten — con Next.js, Firebase, IA y datos estructurados.',
    ...
    website: 'https://carlosanayaruiz.com',
    certsDriveLink:
...
My approach combines high-performance engineering with technical SEO strategy: information architecture, structured data (Schema.org/JSON-LD), Core Web Vitals, internationalization (i18n/hreflang), and web performance. I've led multidisciplinary teams at Amazon, Master Loyalty Group, and Wan Hai Lines, optimizing processes and aligning technology with business goals and organic growth.`,
    shortBio:
      'Software engineer & technical SEO consultant in Mexico. I build fast, indexable, high-converting websites — with Next.js, Firebase, AI, and structured data.',
