        ...
        <div className="grid gap-8 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <div className="mt-4 flex gap-4">
              <a href={SOCIAL_LINKS.linkedin} target="_blank" rel="noopener noreferrer" className="text-muted-foreground transition-colors hover:text-primary" aria-label="Carlos Anaya Ruíz en LinkedIn"><Linkedin className="h-5 w-5" /></a>
              <a href={SOCIAL_LINKS.github1} target="_blank" rel="noopener noreferrer" className="text-muted-foreground transition-colors hover:text-primary" aria-label="Carlos Anaya Ruíz en GitHub"><Github className="h-5 w-5" /></a>
              <a href={`mailto:${SOCIAL_LINKS.email}`} className="text-muted-foreground transition-colors hover:text-primary" aria-label="Email a Carlos Anaya Ruíz"><Mail className="h-5 w-5" /></a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li><a href={SOCIAL_LINKS.fiverr} target="_blank" rel="noopener noreferrer" className="text-sm text-muted-foreground transition-colors hover:text-primary">Fiverr</a></li>
            </ul>
          </div>
        </div>
