...
export default async function TermsPage({ params }: Props) {
  ...
  return (
    <>
      ...
      {/* ══ CABECERA ══════════════════════════════════════════════
          Misma estructura que el aviso de privacidad: la malla animada en
          -z-10 dentro de un contenedor `relative isolate overflow-hidden`,
          decorativa y sin capturar eventos.                          */}
